...
private:
    ...
    static void Rcon(unsigned char* word, int n);
    ...
    static void DecryptBlock(const unsigned char in[], unsigned char out[],
        unsigned char* roundKeys);
public:
    static unsigned char* Encrypt(const unsigned char in[], unsigned int len,
        const unsigned char key[]);

    static unsigned char* Decrypt(const unsigned char in[], unsigned int len,
        const unsigned char key[]);
